...
$stmt = $conn->prepare("SELECT * FROM influencers WHERE category_id=:category AND brand_id=:brand");
    ...
    <div class="card card-client mx-auto text-center">
        ...
        <div class="card-body">
            ...
            <form action="print.php" method="get">
                <input type="hidden" name="table_name" value="influencers">
                <h5 style="text-align: right;"><button type="submit" class="btn btn-info">Print</button></h5>
                <hr>
                <a class="btn btn-secondary" href="clients.php?category=<?php echo $_GET['category']; ?>&brand=<?php echo $_GET['brand']; ?>">All</a>
                <a class="btn btn-primary" href="influencers.php?category=<?php echo $_GET['category']; ?>&brand=<?php echo $_GET['brand']; ?>">Influencers</a>
                <br><br>
